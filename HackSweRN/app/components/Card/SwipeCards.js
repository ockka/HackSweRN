...
export default class SwipeCards extends Component {
  ...
  renderNope() {
    ...
    if (this.props.showNope && this.state.card) {
      return <Animated.View style={[styles.nope, animatedNopeStyles]}>
        <Text style={styles.nopeText}>{this.state.card.left}</Text>
      </Animated.View>;
    }
  ...
  renderYup() {
    ...
    if (this.props.showYup && this.state.card) {
      return <Animated.View style={[styles.yup, animatedYupStyles]}>
        <Text style={styles.yupText}>{this.state.card.right}</Text>
      </Animated.View>;
    }
